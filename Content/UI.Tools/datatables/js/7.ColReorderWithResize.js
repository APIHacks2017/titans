...
(function ($, window, document) {
    ...
    ColReorder = function (oDTSettings, oOpts) {
        ...
        /////////////////
        var propertyCheck = 0;
        if (typeof oDTSettings['oInit'] !== "undefined") {
            propertyCheck = 1;
        }
        if (propertyCheck === 1 && typeof oDTSettings.oInit['allowReorder'] !== "undefined") {
            this.s.allowReorder = oDTSettings.oInit.allowReorder;
        }
    ...
    ColReorder.prototype = {
        ...
        "_fnConstruct": function () {
            ...
            if (typeof this.s.init.fnReorderCallback != 'undefined') {
                console.log('Call back at Pluign');
